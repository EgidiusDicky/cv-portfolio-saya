        ...
        <div v-else-if="project">
            ...
            <div class="relative bg-gray-500 rounded-lg overflow-hidden mb-6">
                ...
                <a v-if="project.images && project.images.length > 0"
                   :href="getFullImageUrl(project.images[currentImage])" <!-- IMPORTANT: Using getFullImageUrl for href -->
                   class="block"
                >
                    <img :src="getFullImageUrl(project.images[currentImage])" <!-- IMPORTANT: Using getFullImageUrl for src -->
